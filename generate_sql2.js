...
const CRITERIA = [
  ...
  { n:12, pr:"P", cat:"components",  t_ar:"الأزرار تتبع نظام التصميم الموحد", t_en:"Buttons follow PC Design System", ref:true },
...
const EXTENSIONS = [
  ...
  { num: 12, desc: 'ضمان توافق عنصر الزر مع معايير التصميم الموحد مع تطبيق جميع الحالات التفاعلية', link: 'https://design.dga.gov.sa/guidelines/components/actions/buttons', subs: ['استخدام الزر كما هو معتمد (الشكل، الحواف، اللون، المسافات) دون تعديل', 'تطبيق الحالات: Default, Hovered, Pressed, Selected, Focused, Disabled'], icon: 'button' },
